...
public class page_3 extends AppCompatActivity {
    ...
    void go_to_page_4()
    {
        ...
        qn = (TextView)findViewById(R.id.q3);
        op_A = (TextView)findViewById(R.id.a3);
        op_B = (TextView)findViewById(R.id.b3);
        op_C = (TextView)findViewById(R.id.c3);

        user_name = (TextView)findViewById(R.id.user_name3) ;
        ...
        Cursor cursor = dataBase_for_question.getContact("3", sqLiteDatabase);
        ...
        question = (RadioGroup)findViewById(R.id.question3);
        ...
        next.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        intent = new Intent(page_3.this,page_4.class);
                        ...
                        else if(!get_ans.getText().toString().equals(option_Ans) && get_ans != null)
                        {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(page_3.this);
                        ...
                        if(get_ans == null)
                        {
                            Toast.makeText(page_3.this,"select your answer",Toast.LENGTH_SHORT).show();
                        }
