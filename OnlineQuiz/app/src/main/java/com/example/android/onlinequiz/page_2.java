...
public class page_2 extends AppCompatActivity {
    ...
    void go_to_page_2()
    {
        ...
        qn = (TextView)findViewById(R.id.q2);
        op_A = (TextView)findViewById(R.id.a2);
        op_B = (TextView)findViewById(R.id.b2);
        op_C = (TextView)findViewById(R.id.c2);

        user_name = (TextView)findViewById(R.id.user_name2) ;
        ...
        Cursor cursor = dataBase_for_question.getContact("2", sqLiteDatabase);
        ...
        question = (RadioGroup)findViewById(R.id.question2);
        ...
        next.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        intent = new Intent(page_2.this,page_3.class);
                        ...
                        else if(!get_ans.getText().toString().equals(option_Ans) && get_ans != null)
                        {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(page_2.this);
                        ...
                        if(get_ans == null)
                        {
                            Toast.makeText(page_2.this,"select your answer",Toast.LENGTH_SHORT).show();
                        }
