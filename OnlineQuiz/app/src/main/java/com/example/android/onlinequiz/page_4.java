...
public class page_4 extends AppCompatActivity {
    ...
    void go_to_page_5()
    {
        ...
        qn = (TextView)findViewById(R.id.q4);
        op_A = (TextView)findViewById(R.id.a4);
        op_B = (TextView)findViewById(R.id.b4);
        op_C = (TextView)findViewById(R.id.c4);

        user_name = (TextView)findViewById(R.id.user_name4) ;
        ...
        Cursor cursor = dataBase_for_question.getContact("4", sqLiteDatabase);
        ...
        next = (Button)findViewById(R.id.next_4);
        question = (RadioGroup)findViewById(R.id.question4);
        ...
        next.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        intent = new Intent(page_4.this,page_5.class);
                        ...
                        else if(!get_ans.getText().toString().equals(option_Ans) && get_ans != null)
                        {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(page_4.this);
                        ...
                        if(get_ans == null)
                        {
                            Toast.makeText(page_4.this,"select your answer",Toast.LENGTH_SHORT).show();
                        }
