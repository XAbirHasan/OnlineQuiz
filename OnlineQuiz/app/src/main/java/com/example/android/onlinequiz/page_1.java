...
public class page_1 extends AppCompatActivity {
    ...
    void go_to_page_2()
    {
        ...
        qn = (TextView)findViewById(R.id.q1);
        op_A = (TextView)findViewById(R.id.a1);
        op_B = (TextView)findViewById(R.id.b1);
        op_C = (TextView)findViewById(R.id.c1);
        ...
        Cursor cursor = dataBase_for_question.getContact("1", sqLiteDatabase);
        ...
        question = (RadioGroup)findViewById(R.id.question1);
        ...
        next.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        intent = new Intent(page_1.this,page_2.class);
                        ...
                        else if(!get_ans.getText().toString().equals(option_Ans) && get_ans != null)
                        {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(page_1.this);
                        ...
                        if(get_ans == null)
                        {
                            Toast.makeText(page_1.this,"select your answer",Toast.LENGTH_SHORT).show();
                        }
